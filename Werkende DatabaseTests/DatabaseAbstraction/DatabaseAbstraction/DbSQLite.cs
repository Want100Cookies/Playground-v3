...
namespace DatabaseAbstraction
{
    ...
    class DbSQLite : DbManagerBase
    {
        ...
        /// <summary>
        /// Initializes this (and the parent) object and sets up a connection.
        /// </summary>
        ...
        public DbSQLite(int type, string path) : base(type)
        {
        ...
        private async void __execCommand(String query, Dictionary<string, dynamic> qParams)
        {
            ...
            {
                this._showErrorMsg(query.Substring(0, 6), e);
            }
